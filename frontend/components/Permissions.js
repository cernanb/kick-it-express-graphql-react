        ...
        <div>
          ...
          <div>
            ...
            <Table>
              ...
              <tbody>
                {!loading && !error && data.users.map(user => <UserPermissions key={user.id} user={user} />)}
              </tbody>
            </Table>
          </div>
        </div>
...
class UserPermissions extends React.Component {
  ...
  togglePermission = (e, updatePermissions) => {
              ...
              <td key={p}>
                <label htmlFor={`${user.id}-permission-${p}`}>
                  <input
                    ...
                    type="checkbox"
                    value={p}
                    onChange={e => this.togglePermission(e, updatePermissions)}
